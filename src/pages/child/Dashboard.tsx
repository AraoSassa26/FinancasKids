...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    async function loadDashboard() {
      try {
        ...
        /*
         * 1. Buscar a criança autenticada com age_groups via Join
         */
        ...
        const rawAgeGroup = childData.age_groups;
        let ageGroupsArray: { name: string; code: string }[] = [];

        if (Array.isArray(rawAgeGroup)) {
          ageGroupsArray = rawAgeGroup;
        } else if (rawAgeGroup) {
          ageGroupsArray = [rawAgeGroup];
        }
        ...
        /*
         * Execução em paralelo da busca de níveis/conteúdo e do progresso do aluno
         */
        const [levelsResult, progressResult] = await Promise.all([
          supabase
            .from("levels")
            .select("id")
        ...
        const completed = progressData.filter((item) => item.completed === true);
        ...
        if (isMounted.current) {
          ...
          const totalXp = completed.reduce(
            (total, item) => total + (Number(item.xp_earned) || 0),
            0
          );
          setXp(totalXp);
        }

        // Processar Capítulos e Aulas
        const levelIds = (levelsResult.data ?? []).map((level) => level.id);

        if (levelIds.length === 0) {
          if (isMounted.current) setChapters([]);
          return;
        }
  ...
  /*
   * Primeiro capítulo e primeira aula disponível
   */
        ...
        <main className="kids-content">
          <section className="kids-hero">
            <div className="hero-content">
              ...
              <p>Estamos a buscar os teus dados.</p>
            </div>
          </section>
        </main>
      </div>
      ...
      <main className="kids-content">
        ...
        <section className="kids-hero">
          <div className="hero-content">
            ...
            <p>
              Aprende, joga e descobre como cuidar melhor do teu dinheiro.
            </p>
          ...
          <div className="hero-illustration">
            ...
            <Star className="hero-star star-one" size={28} />
            <Star className="hero-star star-two" size={20} />
          </div>
        </section>
          ...
          {firstLesson ? (
            <div className="continue-card">
              ...
              <button
                ...
                onClick={() =>
                  navigate(`/child/lesson/${firstLesson.id}`)
                }
            ...
            <div className="continue-card">
              <div className="continue-info">
                ...
                <p>Em breve teremos novas aulas.</p>
              </div>
            </div>
          )}
        </section>
        ...
        <section className="challenge-card">
          ...
          <div className="challenge-content">
            ...
            <h2>Faz uma boa escolha!</h2>

            <p>
              Pensa antes de gastar. Precisas mesmo dessa coisa?
            </p>
        ...
        <section className="dashboard-block">
          ...
          <div className="chapters-list">
            {chapters.map((chapter, index) => {
              ...
              const chapterCompleted = chapterLessonIds.filter((lessonId) =>
              ...
              const chapterProgress =
                chapterLessonIds.length > 0
                  ? Math.round(
                      (chapterCompleted / chapterLessonIds.length) * 100
                    )
                  : 0;
              ...
              return (
                <button
                  ...
                  onClick={() => navigate("/child/lessons")}
                >
                  <div className={`chapter-icon ${color}`}>
                    <Icon size={29} />
                  </div>
        ...
        <section className="reward-card">
          ...
          <div>
            ...
            <p>Completa aulas para desbloquear prémios.</p>
          </div>
        ...
        <section className="tip-card">
          ...
          <div>
            ...
            <h2>Guardar dinheiro é cuidar do futuro.</h2>
            <p>Pequenas poupanças também fazem diferença.</p>
          </div>
        </section>
        ...
        <section className="motivation-card">
          ...
          <h2>Pequenos passos.</h2>
          <h3>Grandes conquistas!</h3>
          <p>
            Cada aula deixa-te mais preparado para cuidar do teu dinheiro.
          </p>
        </section>
      </main>
